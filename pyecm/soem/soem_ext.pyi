...
class SOEM:
    ...
    @overload
    def send_overlap_processdata_group(self, arg: int, /) -> int: ...
    ...
    def send_processdata_group(self, group: int) -> int: ...

    def init(self, ifname: str) -> int: ...

    def config_init(self, usetable: int) -> int: ...

    def config_map_group(self, group: int) -> int: ...

    def config_overlap_map_group(self, group: int) -> int: ...

    def config_map_group_aligned(self, group: int) -> int: ...
