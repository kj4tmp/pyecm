...
def ecx_config_map_group(
    arg0: ecx_contextt,
    arg1: Annotated[
        ArrayLike, dict(dtype="uint8", shape=(None), order="C", device="cpu")
    ],
    arg2: int,
    /,
) -> int: ...
def ecx_config_map_group_aligned(
    arg0: ecx_contextt, arg1: types.CapsuleType, arg2: int, /
) -> int: ...
def ecx_config_overlap_map_group(
    arg0: ecx_contextt, arg1: types.CapsuleType, arg2: int, /
) -> int: ...
def ecx_configdc(arg: ecx_contextt, /) -> int: ...
...
def ecx_init_redundant(
    arg0: ecx_contextt, arg1: ecx_redportt, arg2: str, arg3: str, /
) -> int: ...
